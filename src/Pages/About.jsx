...
// StatCard Component – now supports clickable link
const StatCard = memo(({ icon: Icon, color, value, label, description, animation, link }) => {
  const content = (
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold" data-aos="fade-right" data-aos-duration="1000">
              ...
              <span className="block mt-2 text-gray-200" data-aos="fade-right" data-aos-duration="1300">Sai Ganesh</span>
            </h2>
            <p className="text-base sm:text-lg lg:text-xl text-gray-400 leading-relaxed text-justify pb-4" data-aos="fade-right" data-aos-duration="1500">
              I am Sai Ganesh, passionate about data analytics, machine learning, and problem‑solving. I love building meaningful projects, exploring new technologies, and turning raw data into impactful insights and solutions.
            </p>
